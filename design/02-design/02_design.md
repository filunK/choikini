...
- [2. REST API 設計](#2-rest-api-設計)
    ...
    - [2.2. REST API 詳細](#22-rest-api-詳細)
        ...
        - [2.2.2. POST - /choikini/:user](#222-post---choikiniuser)
            - [2.2.2.1. リクエスト](#2221-リクエスト)
            - [2.2.2.2. レスポンス](#2222-レスポンス)
            - [2.2.2.3. 処理フロー設計](#2223-処理フロー設計)
        - [2.2.3. GET - /choikini/:user](#223-get---choikiniuser)
...
| 項目 | データ型 | 説明 |
|:-----:|:----|:--------|
| isProccessed | boolean | 登録に成功したかどうか |

#### 2.2.2.3. 処理フロー設計

当APIの処理フローについて記述する。

![アクティビティ図](../out/02-design/02-05_ACT_registChoikini/02-05_ACT_ちょい気に登録.svg)

![シーケンス図](../out/02-design/02-05_SEQ_registChoikini/02-05_ACT_ちょい気に登録.svg)

### 2.2.3. GET - /choikini/:user
...
全ユーザのちょい気にを取得する。なお、 __高権限以上の権限__ を持つユーザのみ実行できる。
...
|:----------:|:----|
| p-choikini-token | /loginで取得したワンタイムトークン |
| p-choikini-user | /loginでログインしたユーザ名 |

``` リクエストヘッダ
> GET /choikini HTTP/1.1
> Host: localhost:30000
> User-Agent: insomnia/5.9.6
> Accept: */*
> Accept-Encoding: deflate, gzip
> p-choikini-token: 01fa4a3256d07b7307ad106ac9223b60
> p-choikini-user: admin
```
        ...
        "response": [
            {
                ...
                "choikiniList": [
                    ...
                    {
                        "date": "2017-10-07T05:26:18.659Z",
                        "choikini": "テストちょい気にテキスト"
                    },
                    {
                        "date": "2017-10-15T03:32:51.448Z",
                        "choikini": "テストちょい気にテキスト"
                    }
                ]
            }
...
![アクティビティ図](../out/02-design/02-06_ACT_getAllChoikini/02-06_ACT_ちょい気に取得.svg)

![シーケンス図](../out/02-design/02-06_SEQ_getAllChoikini/02-06_SEQ_ちょい気に取得.svg)
